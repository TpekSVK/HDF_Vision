...
# Align ignore mask overlay with the editor's brush color for consistency.
MASK_COLOR_PRIMARY = QColor(255, 0, 200)
MASK_COLOR_SECONDARY = QColor(255, 0, 200)
MASK_ALPHA_PRIMARY = 160
